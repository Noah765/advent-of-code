...
fn second(input: String) -> usize {
    ...
    red_tiles
        ...
        .flat_map(|(i, a)| {
            ...
            let after_a = if i == red_tiles.len() - 1 {
            ...
            red_tiles
                ...
                .filter(move |b| {
                    a.0 < b.0
                        ...
                        && (a.0 < after_a.0
                            || a.1 < before_a.1
                            || a.0 > before_a.0 && a.1 > after_a.1)
                        || a.0 > b.0
                            && a.1 < b.1
                            && (a.1 < after_a.1
                                || a.0 > before_a.0
                                || a.1 > before_a.1 && a.0 < after_a.0)
                })
                .filter(|b| {
                    !green_lines.iter().any(|(start, end)| {
                        start.0 == end.0
                            ...
                            && (start.1 < b.1 || end.1 < b.1)
                            || start.1 == end.1
                                && start.1 > a.1
                                && end.1 < b.1
                                && (start.0 > a.0.min(b.0) || end.0 > a.0.min(b.0))
                                && (start.0 < a.0.max(b.0) || end.0 < a.0.max(b.0))
                    })
                })
